...
ig=blackbox_pix2struct_proxy_donut_ig
fl=blackbox_pix2struct_proxy_donut_fl
fl_lora=blackbox_pix2struct_proxy_donut_fl_lora
...
do
      ...
      echo "============ Blackbox Pix2Struct-B: Train Proxy Donut ($proxy_save_dir)"
