...
ig=blackbox_pix2struct_proxy_vt5_ig
fl=blackbox_pix2struct_proxy_vt5_fl
fl_lora=blackbox_pix2struct_proxy_vt5_fl_lora
...
do
      ...
      echo "============ Blackbox Pix2Struct-B: Train Proxy VT5 ($proxy_save_dir)"
