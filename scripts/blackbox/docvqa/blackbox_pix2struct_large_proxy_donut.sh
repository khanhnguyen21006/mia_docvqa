...
# Pix2Struct-L as blackbox
model=pix2struct_large
ckpt=google/pix2struct-docvqa-large
...
ig=blackbox_pix2struct_large_proxy_donut_ig
fl=blackbox_pix2struct_large_proxy_donut_fl
fl_lora=blackbox_pix2struct_large_proxy_donut_fl_lora
...
do
      ...
      echo "============ Blackbox Pix2Struct-L: Train Proxy VT5 ($proxy_save_dir)"
